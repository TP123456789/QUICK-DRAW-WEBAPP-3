...
function check_sketch(){
    ...
    if(timer_counter>400){
        document.getElementById("yours_sketch").innerHTML = "Your Sketch: ";
...
function updateCanvas(){
    ...
    background("white");
    random_number = Math.floor((Math.random()*quick_draw_data_set.length)+1);
    Element_of_array = quick_drawn_data_set[random_number];
    sketch = Element_of_array;
...
document.getElementById("yours_sketch").innerHTML = "Your Sketch: "+result[0].label;
